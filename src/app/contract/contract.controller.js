(function () {
    ...
    function ContractController($scope, moment, $stateParams, $state, uiCalendarConfig, ContractLogManager, ContractManager, Restangular) {
        ...
        $scope.getContractsByCus = function (selectedCustomer) {
            ...
            ContractManager
                ...
                .getList()
                .then((contracts) => {
                    $scope.contracts = Restangular.stripRestangular(contracts);
                })
                .finally(() => {
                    $scope.formProcessing = false;
                });
